...
const Game = React.memo(({ game, updateSearchWindow }) => {
  const startDateLocaleString = game.startDateLocaleString
    ? game.startDateLocaleString
    : timeConverter(game.startDate).toLocaleDateString();
      ...
      >
        <StyledInfo>
          ...
          <div>
            ...
            {isResultsVisibile && (
              <StyledVS>{`${game.scores[0]} - ${game.scores[1]}`}</StyledVS>
            )}
          </div>
          <StyledTeam>
        ...
        <StyledInfo>
          <StyledTeam>
            <StyledTeamTitle>{game.competitors[0].name}</StyledTeamTitle>
          </StyledTeam>
          <div>
          ...
          <StyledTeam>
            <StyledTeamTitle>{game.competitors[1].name}</StyledTeamTitle>
          </StyledTeam>
        </StyledInfo>
        <StyledButtonsContainer>
          <StyledShowResults background={game.competitors[0].secondaryColor}>
